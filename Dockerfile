...
RUN apt-get update && apt-get install -y build-essential unzip curl python3-pip python3-dev python3-matplotlib \
    python3-lxml python3-numpy python3-dateutil python3-gdal python3-yaml python3-serial python3-xlwt python3-shapely \
    python3-pil python3-reportlab python3-tweepy python3-xlrd python3-pyth python3-boto ansible \
